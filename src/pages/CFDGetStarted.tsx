              ...
              <div className="scrollbar-hidden">
                ...
                <div className="min-h-screen flex flex-col items-center justify-center bg-white text-black rounded-lg p-8">
                  <div className="max-w-2xl mx-auto text-center space-y-8">
                    ...
                    {/* CTA Button */}
                    <button className="bg-[#00B7FF] text-white px-12 py-4 rounded-full text-lg font-semibold hover:bg-[#0066CC] transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                      무료 체험 시작하기
                    </button>
