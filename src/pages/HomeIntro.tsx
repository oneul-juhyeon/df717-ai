        ...
        <header className="flex justify-between items-center pt-14 max-sm:pt-5">
          ...
          <NavigationMenu>
            <NavigationMenuList className="gap-2">
              ...
              <NavigationMenuItem>
                <Link to="/company" className="text-gray-800 hover:text-gray-600 px-4 py-2 transition">
                  Company
                </Link>
              </NavigationMenuItem>
              <NavigationMenuItem>
          ...
          <Card className="bg-white border-gray-200 text-gray-800 shadow-md">
            <CardContent className="p-12 max-sm:p-6">
              <div className="max-w-3xl mx-auto">
                <h1 className="text-5xl mb-16 text-gray-900 font-gotham font-bold max-md:text-4xl max-sm:text-3xl max-sm:mb-10">
                  상황AI와 감정AI의 어셈블!
                </h1>
                
                <h2 className="text-4xl text-gray-900 font-gotham font-bold max-md:text-3xl max-sm:text-2xl mb-10">
                  inDJ TACT AI <span className="text-3xl max-md:text-2xl max-sm:text-xl">논치 AI</span>
                </h2>
                
                <div className="prose prose-slate max-w-3xl text-lg space-y-6">
                ...
                <div className="mt-16 flex gap-6 max-sm:flex-col">
                  <Card className="bg-gray-50 border-gray-200 p-0 overflow-hidden flex-1 shadow-sm">
                    <CardHeader className="p-6 pb-3">
                      <CardTitle className="text-2xl text-gray-800">AI 기술 소개</CardTitle>
                    </CardHeader>
                  ...
                  <Card className="bg-gray-50 border-gray-200 p-0 overflow-hidden flex-1 shadow-sm">
                    <CardHeader className="p-6 pb-3">
                      <CardTitle className="text-2xl text-gray-800">회사 비전</CardTitle>
                    </CardHeader>
                    <CardContent className="px-6 pb-6">
                      <p className="text-gray-700">
