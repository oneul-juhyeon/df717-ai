  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto flex flex-col space-y-24 md:space-y-32 z-10 text-center">
        ...
        >
          <p className="font-din text-base text-white leading-relaxed tracking-wider">
        ...
        <motion.div 
          ...
          className="text-center"
        >
          <p className="font-din text-base font-bold text-white leading-relaxed tracking-wider">
        ...
        >
          <Link 
            to="/company" 
            className="inline-flex items-center border border-white/70 text-white hover:bg-white/10 transition-colors px-8 py-3 tracking-wider font-din text-base"
          >
