...
const SharesWhatAre: React.FC = () => {
  return (
    <>
      <h1 className="text-4xl mt-8 mb-4">What are stocks?</h1>
      ...
      <h2 className="text-3xl mt-12 mb-4">What is the difference between stocks and shares?</h2>
      <p className="mb-4 text-left">
      ...
      <p className="mb-4 text-left">
        Trader A: Hey! Which stocks do you have in your portfolio?<br />
        Trader B: Oh, I've got Google and Facebook.<br />
        So, using the above example, this is how it might continue:
      </p>
      <p className="mb-4 text-left">
        Trader A: Oh, that's cool. How many shares of Google did you buy?<br />
        Trader B: I bought 100 shares of Google.
      </p>
      <p className="mb-4 text-left">
        The term "shares", however, refers to a specific stock's quantity.
      </p>
    </>
  );
};

export default SharesWhatAre;
