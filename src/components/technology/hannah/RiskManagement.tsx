    ...
    y: 20
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-9">
        ...
        delay: 0.3
          ...
          <p className="text-sm text-gray-300">The DF717 robot and HANNAH engine are constantly developing. R&D efforts continue to enhance asset allocation technologies.</p>
        </motion.div>
      </div>
    </motion.div>;
};
