...
const IsaacComponent = () => {
  ...
  return <div className="max-w-4xl mx-auto text-white">
      ...
      duration: 0.5
        ...
        <motion.div ref={sectionRef2} className="mt-24" initial={{
        opacity: 0,
        y: 20
      }} animate={controls2}>
        ...
        <motion.div ref={sectionRef3} className="mt-24" initial={{
        opacity: 0,
        y: 20
      }} animate={controls3}>
        ...
        <motion.div ref={sectionRef4} className="mt-24" initial={{
        opacity: 0,
        y: 20
      }} animate={controls4}>
