...
const AxiTrustDemo: React.FC = () => {
  ...
  return <div ref={sectionRef} className="grid grid-cols-1 md:grid-cols-2 gap-10 transition-all duration-1000 transform opacity-0 translate-y-10">
      ...
      <div className="flex items-center justify-center">
        <img src="/lovable-uploads/8335e11c-a525-43db-a8bd-533a8d647451.png" alt="Trading platform with traders analyzing charts" className="max-w-full h-auto rounded-xl object-cover" />
      </div>
    </div>;
};
