...
const AxiAwardWinningService: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="py-12 bg-[#161616] scroll-animate opacity-0">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-white scroll-animate opacity-0">
      ...
      <div className="py-16 bg-[#161616]">
        <div className="max-w-6xl mx-auto px-4 scroll-animate opacity-0">
          <AxiServiceImages />
        </div>
      </div>
      ...
      <div className="py-16 bg-[#1A1A1A]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 flex justify-center scroll-animate opacity-0">
              <img 
            ...
            <div className="order-1 md:order-2 text-white scroll-animate opacity-0">
