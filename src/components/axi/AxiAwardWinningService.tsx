  ...
  return <div className="flex flex-col w-full">
      ...
      <div className="py-16 bg-[#161616]">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="scroll-animate opacity-0" style={{
      ...
      <div className="py-16 bg-[#1A1A1A]">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <h3 className="text-3xl font-bold mb-6 scroll-animate opacity-0" style={{
          transitionDelay: '100ms'
        }}>100% committed to you.</h3>
          
          <p className="text-gray-300 mb-12 max-w-3xl mx-auto scroll-animate opacity-0" style={{
          transitionDelay: '200ms'
        }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            {Array.from({
            length: 4
          }).map((_, index) => <Card key={index} className="bg-[#232323] border-none scroll-animate opacity-0 hover:translate-y-[-5px] transition-all duration-300" style={{
          ...
          <p className="text-sm text-gray-400 mt-4 scroll-animate opacity-0" style={{
          transitionDelay: '700ms'
        }}>** Axi Group of companies</p>
          
          <div className="mt-12 p-6 bg-[#232323] rounded-lg scroll-animate opacity-0" style={{
          transitionDelay: '800ms'
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-6 md:mb-0">
                <div className="flex items-center">
                  ...
                  <div className="flex ml-2">
                    {Array.from({
                    length: 5
                  }).map((_, i) => <span key={i} className="text-green-500">★</span>)}
                  </div>
                </div>
              ...
              {Array.from({
              length: 3
            }).map((_, index) => <div key={index} className="mb-4 md:mb-0">
                  <div className="flex items-center">
                    <div className="flex">
                      {Array.from({
                    length: 5
      ...
      <div className="py-16 bg-[#161616]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center scroll-animate opacity-0" style={{
            transitionDelay: '200ms'
          }}>
      ...
      <div className="py-16 bg-[#1A1A1A]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 flex justify-center scroll-animate opacity-0" style={{
            transitionDelay: '100ms'
          }}>
              <div className="w-64 h-64 bg-[#232323] rounded-full overflow-hidden flex items-center justify-center transform transition-all duration-500 hover:scale-105">
                <Users className="h-24 w-24 text-[#9b87f5]" />
