  ...
  return <section className="py-16 bg-black">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {features.map((feature, index) => <div key={index} className="flex flex-col items-center text-center transition-opacity duration-700 opacity-0 animate-fade-in-up" style={{
