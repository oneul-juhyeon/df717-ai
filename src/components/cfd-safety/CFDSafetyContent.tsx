...
const CFDSafetyContent: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto text-white">
      ...
      <div className="mt-8">
        <img 
          src="/lovable-uploads/why%20cfd%20safety%20matters%201.png" 
      ...
      <div className="prose prose-invert max-w-none text-left">
        ...
        <div className="mt-8 mb-8">
          <img 
            src="/lovable-uploads/why%20cfd%20safety%20matters%202.png" 
        ...
        <div className="mt-8 mb-8">
          <img 
            src="/lovable-uploads/why%20cfd%20safety%20matters%203.png" 
        ...
        <div className="mt-8 mb-8">
          <img 
            src="/lovable-uploads/why%20cfd%20safety%20matters%204.png" 
        ...
        <div className="mt-8 mb-8">
          <img 
            src="/lovable-uploads/why%20cfd%20safety%20matters%205.png" 
