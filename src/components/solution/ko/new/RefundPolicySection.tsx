          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-8 lg:p-10">
              ...
              <div className="space-y-6 text-muted-foreground">
                <div>
                  <h4 className="font-semibold text-foreground mb-3 text-base leading-[1.4] text-justify">제22조 (환불)</h4>
                  <p className="leading-[1.6] text-base text-justify">
                    1. 회원은 회사에 환불을 요구할 수 있습니다. 환불은 회사가 안내하는 정책 및 방법에 따라 진행됩니다.
                  </p>
                </div>

                <div>
                  <p className="mb-4 leading-[1.6] text-base text-justify">2. 회사는 다음 각 호의 방식으로 환불을 진행합니다.</p>
                  ...
                  <div className="pl-5 space-y-5">
                    <div>
                      ...
                      <p className="text-sm mt-3 leading-[1.7] text-justify">
                    ...
                    <div>
                      <p className="font-medium text-foreground mb-2 text-base leading-[1.4] text-justify">나. 연간 결제 회원:</p>
                      <p className="text-sm leading-[1.7] text-justify">
