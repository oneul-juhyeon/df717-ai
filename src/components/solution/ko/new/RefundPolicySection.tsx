                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="pl-5 space-y-6">
                      <div>
                        <p className="font-medium text-foreground mb-3 text-base leading-[1.4]">가. 정기 결제 회원:</p>
                      ...
                      <div>
                        <p className="font-medium text-foreground mb-3 text-base leading-[1.4]">나. 연간 결제 회원:</p>
                        <p className="text-sm leading-[1.7]">
