...
const SolutionStepsKo: React.FC = () => {
  return <section className="w-full bg-gradient-to-b from-black to-gray-900 py-20 md:py-32 px-6 md:px-10 lg:px-[154px]">
      ...
      duration: 0.8
        ...
        duration: 0.6
      }} className="text-4xl md:text-5xl font-bold text-white text-center mb-6 lg:text-6xl">5단계로 간단하게 시작하세요</motion.h2>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 relative z-10">
            {steps.map((step, index) => <motion.div key={step.number} className="relative" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
