...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return <div className={`relative overflow-hidden rounded-2xl ${className}`}>
      ...
      <div className="absolute left-14 top-14 max-sm:left-5 max-sm:top-5">
        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/accb95c776f733b687666411d4085dc095962eff" alt="Hero logo" className="w-[450px] max-lg:w-[600px] max-sm:w-[280px] h-auto" />
