  ...
  persist(
    (set, get) => ({
      ...
      proceedToStep: (step: number) => {
        ...
        console.log(
          `Attempting to proceed to step ${step}, isProcessing: ${isProcessing}, isStepExecuted: ${isStepExecuted(step)}`,
        );
          ...
          switch (step) {
            case 1: {
              ...
              const brokerUrl = isDemo
                ...
                : "https://www.vantagemarkets.com/ko/open-live-account/?affid=MjA3OTUxMjQ=";
              ...
              if (isDemo) {
                ...
                get().addMessageGroup([
                  ...
                  },
                  {
                    ...
                    content:
                      "📋 **Account 페이지에서 다음 정보를 확인할 수 있어요:**\n\n• **Account ID** (계좌번호)\n• **Password** (비밀번호)\n• **Server** (서버명)",
                    sender: "ai",
                    type: "info_box",
                    timestamp: new Date(),
                    animate: false,
              ...
              if (isDemo) {
                ...
                get().addMessageGroup([
                  ...
                  },
                  {
                    id: "step-7-info",
                    content:
                      '📱 앱스토어 또는 구글 플레이에서 **"Vantage"** 앱을 검색 후 설치합니다.\n설치 완료 후 앱을 실행해주세요.',
                    sender: "ai",
                    type: "info_box",
                    timestamp: new Date(),
                    animate: false,
                  ...
                  },
                  {
                    ...
                    buttons: [
                      ...
                      },
                      {
                        ...
                        action: () => {
                          window.open(
                            "https://apps.apple.com/kr/app/vantage-all-in-one-trading-app/id1457929724",
                            "_blank",
                          );
                        },
                      },
              ...
              if (isDemo) {
                ...
                get().addMessageGroup([
                  ...
                  },
                  {
                    id: "step-9-intro",
                    content:
                      "축하합니다! 이제 실시간으로 거래 내역과 수익률을 확인하실 수 있어요.\n프로그램 운용이 시작되면 매니저를 통해 전달해드릴게요!",
                    sender: "ai",
                    type: "text",
                    timestamp: new Date(),
                    animate: false,
                        ...
                        ...state.messages,
                        {
                          ...
                          buttons: [
                            ...
                            },
                            {
                              ...
                              action: () => {
                                window.open(
                                  "https://aiwow.notion.site/DF717-LIVE-ACCOUNT-20dc67e3da6880dfbc4cefa57ae38bf7",
                                  "_blank",
                                );
                              },
                            },
                            {
                              ...
                              action: () => {
                                window.open(
                                  "https://aiwow.notion.site/DF717-Backtest-20fc67e3da68809780c0f8302bfc12bf",
                                  "_blank",
                                );
                              },
                            },
            ...
            case 10: {
              ...
              const { userData } = get();
              const isCentAccount = userData.accountSubType === "cent";
              ...
              get().addMessageGroup([
                ...
                {
                  id: "step-10-info",
                  content: `💰 **DF717 최소 투자금**: ${minAmountDisplay} 이상`,
                  sender: "ai",
                  type: "info_box",
                  timestamp: new Date(),
                  animate: false,
        ...
        set((state) => ({
          messages: state.messages.map((message) =>
            message.id === messageId && message.formFields
              ? {
                  ...message,
                  formFields: message.formFields.map((field) => (field.id === fieldId ? { ...field, value } : field)),
                }
              : message,
          ),
        }));
