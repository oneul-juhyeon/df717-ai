    ...
    (set, get) => ({
      ...
      initializeChat: () => {
        ...
        setTimeout(() => {
          get().addMessage({
            id: 'welcome-1',
            content: 'How would you like to begin your AI investing journey today?',
            sender: 'ai',
            type: 'text',
            timestamp: new Date(),
            animate: false,
          ...
          setTimeout(() => {
            get().addMessage({
              id: 'welcome-2',
              content: 'You can start AI automated investing in just 3 minutes.',
              sender: 'ai',
              type: 'text',
              timestamp: new Date(),
              animate: false,
        ...
        setTimeout(() => {
          get().addMessage({
            ...
            buttons: [
              {
                label: '📊 Try Demo',
                description: 'Safe practice with free demo account',
                type: 'card',
                action: () => {
