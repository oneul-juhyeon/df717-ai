  ...
  return (
    <div className="max-w-4xl mx-auto text-white">
      ...
      <div className="prose prose-invert max-w-none text-left">
        ...
        <div className="bg-green-900/20 border-l-4 border-green-500 p-6 rounded mb-8">
        ...
        <div className="bg-green-900/20 border border-green-500/30 p-6 rounded-lg text-center mb-8">
        ...
        <div className="bg-green-900/20 border-l-4 border-green-500 p-6 rounded mb-8">
          <p className="text-green-400 text-lg font-semibold text-center">
            <strong>Experience the difference that true professional trading makes.</strong>
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <a 
            href="https://www.icmarkets.com/global/ko/open-trading-account/demo/?camp=83293" 
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold py-4 px-8 rounded-lg transition-colors duration-200 text-lg"
          >
            ➡️ Open ICMarkets Account → Start trading with institutional-grade conditions
          </a>
        </div>
      </div>
    </div>
